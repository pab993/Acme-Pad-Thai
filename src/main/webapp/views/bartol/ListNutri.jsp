...
<display:table name="bartols" id="bartol" pagesize="5" requestURI="${requestURI}" class="displaytag">
	...
	<security:authorize access="hasRole('NUTRITIONIST')">
		<display:column>
			<jstl:if test="${row.nutritionist.id != nutriVar.id }">
				<a href="bartols/recipe/edit.do?bartolId=${row.id}">
...
<security:authorize access="hasRole('NUTRITIONIST')">
	<div>
		<a href="bartols/recipe/create.do"><spring:message code="bartol.create"/></a>
	</div>	
</security:authorize>
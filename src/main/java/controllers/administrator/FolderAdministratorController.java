...
public class FolderAdministratorController {
	...
	public ModelAndView list() {
		...
		Administrator admin = administratorService.findOneByuserAccountId(LoginService.getPrincipal().getId());
		folders = admin.getFolders();

		result = new ModelAndView("folder/list");
		result.addObject("requestURI", "folder/administrator/list.do");
